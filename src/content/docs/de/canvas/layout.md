...
- **Buttons der Hauptnavigation (③)**: Schnellzugriffslinks zu häufig genutzten Bereichen wie „Startseite", „Produktbeschreibung" und „Schnelleinstieg"; der aktuell aufgerufene Bereich wird automatisch hervorgehoben.
...
*Abbildung: Darstellung derselben Website im hellen Design (am Beispiel der Schnelleinstieg-Seite).*
