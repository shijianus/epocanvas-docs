...
| :--- | :--- | :--- |
| `Header.astro` | unas 639 líneas | Todo el contenido de la barra superior: logo, cuadro de búsqueda, navegación principal, insignia de versión, selector de idioma, conmutador de theme, accesos a GitHub y Telegram |
