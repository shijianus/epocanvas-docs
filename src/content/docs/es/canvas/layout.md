...
- **Extracción automática de encabezados**: al renderizar la página, el sistema analiza automáticamente los encabezados de nivel 2 (`##`) y de nivel 3 (`###`) del documento actual y genera el "En esta página".
